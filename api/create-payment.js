...
module.exports = async function (req, res) {
  ...
  const targetPath = "/qris-merchant-hosted/v1/generate-qr-code";
  ...
  const requestBody = {
    ...
    payment: {
      payment_due_date: 60, // Kedaluwarsa dalam 60 menit
    },
    customer: {
  ...
  // 1. Generate Digest (SHA256 dari Request Body)
  const digest = crypto.createHash("sha256").update(jsonBody, "utf8").digest("base64");

  // 2. Generate Component Signature
